...
public class JiraPayLoad {
	...
	public static String JiraCreateIssuePayload(){
		String createIssuePayload="{\r\n" + 
				...
				"          \"key\": \"JIRARES\"\r\n" + 
				"       },\r\n" + 
				"       \"summary\": \"Issue Created to update comment for Rest Assured\",\r\n" + 
				"       \"description\": \"Debit card UI issue practical from Rest Assured\",\r\n" + 
				"       \"issuetype\": {\r\n" + 
				"          \"name\": \"Bug\"\r\n" + 
				"       }\r\n" + 
				"   }\r\n" + 
	...
	public static String JiraAddCommentPayload()
	{
		String addCommentPayload="{\r\n" + 
				"    \"body\": \"Initial added comment by Ram from Rest Assured\",\r\n" + 
				"    \"visibility\": {\r\n" + 
				"        \"type\": \"role\",\r\n" + 
